...
main:   # This is the entry point of our program
    ...
    la    $a0, msg # make $a0 point to where the message is load string address
    li    $v0, 4   # $v0 <- 4 load immediate 4 means to print the string hello world 
    syscall        # Call the OS to print the message

    # This is the standard way to end a program
    li    $v0, 10
    syscall        # end the program 10 here means to exit the program.
